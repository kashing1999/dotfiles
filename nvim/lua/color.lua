...
vim.api.nvim_create_autocmd("colorscheme", {
    ...
    callback = function(args)
        vim.api.nvim_set_hl(0, "IndentBlanklineContextChar", { fg = vim.api.nvim_get_hl_by_name("String", true).foreground})
        vim.api.nvim_set_hl(0, "IndentBlanklineContextStart", { sp = vim.api.nvim_get_hl_by_name("String", true).foreground, underline=true })
